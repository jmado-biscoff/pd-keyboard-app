...
export default function TopRowModule() {
  ...
  const lessons = [
    ...
    "qwer uiop qwer uiop",
    "quit were ripe pure wire rope",
    "query wipe quip ripe wire tire",
    "q w e r t y u i o p",
    "quiet writer pours pure wire",
  ];
  ...
  const getPerformanceMessage = () =>
    wpm >= 40 && accuracy >= 95
      ? "Fantastic typing! You’ve mastered the top row!"
      : wpm >= 25 && accuracy >= 85
      ? "Nice progress! Keep refining your control."
      : "Good effort! Focus on hitting the correct keys.";
          ...
          <PixelCard className="mb-8 bg-black/60 border-[3px] border-yellow-300 backdrop-blur-sm">
            ...
            <input
              ...
              placeholder={
                completed
                  ? "Module completed!"
                  : `Lesson ${currentIndex + 1}: Type using QWERTY UIOP`
              }
              autoFocus
            />
          </PixelCard>
