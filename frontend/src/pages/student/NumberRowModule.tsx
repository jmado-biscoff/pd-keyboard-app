...
import bgImage from "@/assets/b4.jpg"; // 🔹 Optional: change background for this module

export default function NumbersRowModule() {
  ...
  const getPerformanceMessage = () =>
    wpm >= 40 && accuracy >= 95
      ? "Outstanding! You’ve mastered the numbers row!"
      : wpm >= 25 && accuracy >= 85
      ? "Great work! Your number accuracy is improving."
      ...
      <div className="relative z-10 p-8 min-h-screen text-white">
        <div className="max-w-6xl mx-auto">
          ...
          <PixelCard className="mb-8 bg-black/60 border-[3px] border-yellow-300 backdrop-blur-sm">
            ...
            <input
              ...
              placeholder={
                completed
                  ? "Module completed!"
                  : `Lesson ${currentIndex + 1}: Type using 1234567890`
              }
              autoFocus
            />
          </PixelCard>
          ...
          <PixelCard className="mb-8 text-center bg-black/60 border-[3px] border-yellow-300 backdrop-blur-sm">
            <h3 className="font-pixel text-sm mb-4 text-white">Numbers Row Layout</h3>
