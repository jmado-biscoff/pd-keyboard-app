...
train_loader, test_loader, input_dim = load_data(data_path, sequence_length=SEQ_LEN, batch_size=BATCH_SIZE)
...
# Save inference time in milliseconds
inference_time_ms = ((time.time() - start_infer) / len(y_true)) * 1000
precision = precision_score(y_true, y_pred, zero_division=0)

# ============================================================
# SAVE MODEL + ONNX EXPORT
# ============================================================
save_path = os.path.abspath(
    os.path.join(os.path.dirname(__file__), "..", "saved", "gru_model.pth")
)
...
json_path = os.path.abspath(
    os.path.join(os.path.dirname(__file__), "..", "saved", "gru_metrics.json")
)
...
print("GRU model and metrics saved successfully.")
